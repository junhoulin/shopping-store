  ...
  <footer>
                    ...
                    <li>
                        <ul class="social-link">
                            <li class="footer-nav-item">
                                <a href="#" class="footer-nav-link"><Icon icon="ic:baseline-facebook" /></a>
                            </li>

                            <li class="footer-nav-item">
                                <a href="#" class="footer-nav-link"><Icon icon="mdi:twitter" /></a>
                            </li>

                            <li class="footer-nav-item">
                                <a href="#" class="footer-nav-link"><Icon icon="ri:instagram-fill" /></a>
                            </li>

                            <li class="footer-nav-item">
                                <a href="#" class="footer-nav-link"><Icon icon="mdi:github" /></a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="footer-bottom">
        <div class="container">
          ...
          <p class="copyright">Copyright &copy; <a href="#">Jun</a> all rights reserved</p>
        </div>
    </div>
  </footer>
</template>
